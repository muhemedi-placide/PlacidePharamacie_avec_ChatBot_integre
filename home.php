...
<head>
  ...
  <!-- Place ce script à la fin de ton body -->
  <script src="https://cdn.botpress.cloud/webchat/v3/inject.js"></script>
  <script>
    window.botpressWebChat.init({
      hostUrl: "https://cdn.botpress.cloud/webchat/v3",
      botId: "C43355ZJ", // ton bot ID
      clientId: "webchat", // tu peux personnaliser
      configUrl: "https://files.bpcontent.cloud/2025/12/08/13/20251208133820-C43355ZJ.json",
      showWidget: true, // affiche directement le widget
      enableReset: true
    });
  </script>
...
<body>
  <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
    ...
    <div class=" navbar-inner">
      <div class="container-fluid">
        ...
        <a class="brand" href="#"><b>PlaciPhara</b></a>
        <div class="nav-collapse">

          <ul class="nav pull-right">

            <!-- <div style="width: 350px; height: 500px; border: 1px solid #ccc;">
    <iframe 
        src="https://cdn.botpress.cloud/webchat/v3.3/shareable.html?configUrl=https://files.bpcontent.cloud/2025/12/08/13/20251208133820-C43355ZJ.json" 
  ...
  <!-- <div id="chatbox" style="width: 350px; border: 1px solid #ccc; padding: 10px;">
    <div id="messages" style="height: 300px; overflow-y: auto;"></div>

    <input type="text" id="message" placeholder="Posez une question..." style="width: 100%; margin-top: 10px;">
